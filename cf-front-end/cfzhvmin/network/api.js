...
// 获取汽车类型
export const getVehicleTypeList = (data) => $http(
	'/ucenter/cfVehicleType/getVehicleTypeList', 'GET', data)
// 根据车架号查询车辆信息
export const getInfoByVin = (data) => $http(
	'/ucenter/cfUserDrivingLicense/getInfoByVin', 'GET', data)
//添加行驶证
export const addDrivingLicense = (data) => $http('/ucenter/cfUserDrivingLicense/addUserDrivingLicense', 'POST', data)
// 查询行驶证信息
export const getdrivingList = (data) => $http(
	'/ucenter/cfUserDrivingLicense/getMyUserDrivingLicenseList', 'GET', data)
//添加预约
export const addCarParkVisit = (data) => $http('/internetOfThings/cfCarParkUseLog/addCarParkVisit', 'POST', data)
//货物补录
export const additionalRecordingTransportationGoods = (data) => $http('/internetOfThings/cfCarParkUseLog/additionalRecordingTransportationGoods', 'POST', data)
//查询设备列表
export const getDeviceListByQuery = (data) => $http(
	'/internetOfThingsAdmin/cfDevice/getListByQuery', 'GET', data)
//控制设备开关闸
export const controllerCarParkDeviceSwitch = (data) => $http('/internetOfThingsAdmin/cfDevice/controllerDeviceSwitch', 'POST', data)

// 查询订阅消息模板
export const getSubscribeMessageTemplateListApi = (data) => $http(
	'/ucenter/cfUser/getSubscribeMessageTemplateListByQuery', 'GET', data)