		...
		methods: {
			...
			onCommonlyUsedFunction(index) {
				const pages = [
					...
					'/pages/myCar/myCar',
					// #ifdef MP-WEIXIN
					'/packageMy/my/monthlyCardPackage',
					'/packageMy/my/myWallet',
					// #endif
					'/packageMy/my/emergency',
					'/packageMy/my/orderList',
					'/packageMy/my/setMyInfo',
					'/pages/coupon/index',
					'/packageMy/my/myCoupon',
					// #ifdef MP-WEIXIN
					'/packageMy/my/storedValueCard',
					'/packageMy/my/chargingStoredValueCard',
					'/packageAdmin/park/parkList',
					'/packageAdmin/park/drivingLicense',
					'/packageAdmin/park/goodsAdditionalRecording',
					// #endif
