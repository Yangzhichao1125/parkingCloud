...
const DASHBOARD: AppRouteRecordRaw = {
  ...
  children: [
    ...
    {
      path: 'userDrivingLicenseList',
      name: 'UserDrivingLicenseList',
      component: () => import('@/views/user/drivingLicenseList/index.vue'),
      meta: {
        locale: 'menu.ucenter.certificate.drivinglicenselist',
        requiresAuth: true,
        roles: ['*'],
        hideInMenu: false,
      },
    ...
    {
      path: 'subscribeMessageTemplateList',
      name: 'SubscribeMessageTemplateList',
      component: () => import('@/views/user/subscribeMessageTemplate/index.vue'),
      meta: {
        locale: 'menu.ucenter.user.subscribeMessageTemplateList',
        requiresAuth: true,
        roles: ['*'],
        hideInMenu: false,
      },
