...
//行驶证
export function getUserDrivingLicenseListByQuery(params: any) {
  return axios.get<any>(
      '/ucenterAdmin/cfUsercertificate/getUserDrivingLicenseListByQuery',
      params
  );
}
export function deleteUserDrivingLicense(params: any) {
  return axios.delete(
      '/ucenterAdmin/cfUsercertificate/deleteUserDrivingLicense',
      params
  );
}
export function addUserDrivingLicense(data: any) {
  return axios.post('/ucenterAdmin/cfUsercertificate/addUserDrivingLicense', data);
}
export function updateUserDrivingLicense(data: any) {
  return axios.put(
      '/ucenterAdmin/cfUsercertificate/updateUserDrivingLicense',
      data
  );
}
...
//订阅消息模板
export function getSubscribeMessageTemplateListByQuery(params: any) {
  return axios.get<any>('/ucenterAdmin/cfUser/getSubscribeMessageTemplateListByQuery', params);
}
export function addSubscribeMessageTemplate(data: any) {
  return axios.post('/ucenterAdmin/cfUser/addSubscribeMessageTemplate', data);
}
export function updateSubscribeMessageTemplate(data: any) {
  return axios.put(
      '/ucenterAdmin/cfUser/updateSubscribeMessageTemplate',
      data
  );
}
export function deleteSubscribeMessageTemplate(params: any) {
  return axios.delete(
      '/ucenterAdmin/cfUser/deleteSubscribeMessageTemplate',
      params
  );
}
...
// 汽车类型
export function getVehicleTypeListByQuery(data: any) {
  return axios.get(
      '/ucenter/cfVehicleType/getVehicleTypeList',
      data
  );
}
// 车辆使用性质
export function getUseNatureListByQuery(data: any) {
  return axios.get(
      '/ucenter/cfVehicleType/getVehicleUseNatureList',
      data
  );
}
// 车辆排放阶段
export function getEmissionStageListByQuery(data: any) {
  return axios.get(
      '/ucenter/cfVehicleType/getVehicleEmissionStageList',
      data
  );
}
// 车辆燃油类型
export function getFuelTypeListByQuery(data: any) {
  return axios.get(
      '/ucenter/cfVehicleType/getVehicleFuelTypeList',
      data
  );
}
// 车辆机械类型
export function getMachineTypeListByQuery(data: any) {
  return axios.get(
      '/ucenter/cfVehicleType/getVehicleMachineTypeList',
      data
  );
}
