...
export function flushStatisticsParkDatas(params: any) {
  return axios.get<any>(
    '/internetOfThingsAdmin/cfCarPark/flushStatisticsParkDatas',
    params
  );
}

export function getCfCouponActivityLinkShopList(params: any) {
  return axios.get<any>(
    '/payAdmin/cfCoupon/getCfCouponActivityLinkShopListByQuery',
    params
  );
}
