...
export function imitateCarParkUseLog(data: any) {
  return axios.post('/internetOfThingsAdmin/cfCarPark/imitateCarParkUseLog', data);
}
...
export function cancelUseLogOut(data: any) {
  return axios.put(
      '/internetOfThingsAdmin/cfCarPark/cancelUseLogOut',
      data
  );
}
...
export function exportChargingRulesExcel(params: any) {
  return axios.get<any>(
      '/internetOfThingsAdmin/cfCarPark/exportChargingRulesExcel',
      params,
  );
}
export function exportElectronicLedger(params: any) {
  return axios.get<any>(
      '/internetOfThingsAdmin/cfCarPark/exportElectronicLedgerLogExcel',
      params,
  );
}
export function getUseLogFeeIllustrateList(params: any) {
  return axios.get<any>(
      '/internetOfThingsAdmin/cfCarPark/getUseLogFeeIllustrateList',
      params,
  );
}

// 电子台账记录
export function electronicLedgerLogGet(params: any) {
  return axios.get<any>(
      '/internetOfThingsAdmin/cfCarPark/getCarParkElectronicLedgerListByQuery',
      params
  );
}
export function getElectronicLedgerLogImages(params: any) {
  return axios.get<any>(
      '/internetOfThingsAdmin/cfCarPark/getCarParkUseLogImages',
      params
  );
}
export function electronicLedgerDelete(params: any) {
  return axios.delete(
      '/internetOfThingsAdmin/cfCarPark/deleteCarParkElectronicLedger',
      params
  );
}
export function electronicLedgerAdd(data: any) {
  return axios.post('/internetOfThingsAdmin/cfCarPark/addCarParkElectronicLedger', data);
}
export function electronicLedgerUpdate(data: any) {
  return axios.put(
      '/internetOfThingsAdmin/cfCarPark/updateCarParkElectronicLedger',
      data
  );
}
export function exportElectronicLedgerExcel(params: any) {
  return axios.get<any>(
      '/internetOfThingsAdmin/cfCarPark/exportElectronicLedgerLogExcel',
      params,
  );
...
//车辆限制时间
export function getCarParkCarLimitTimeListByQuery(params: any) {
  return axios.get<any>(
      '/internetOfThingsAdmin/cfCarPark/getCarParkCarLimitTimeListByQuery',
      params
  );
}
export function addCarParkCarLimitTime(data: any) {
  return axios.post(
      '/internetOfThingsAdmin/cfCarPark/addCarParkCarLimitTime',
      data
  );
}
export function updateCarParkCarLimitTime(data: any) {
  return axios.put(
      '/internetOfThingsAdmin/cfCarPark/updateCarParkCarLimitTime',
      data
  );
}
export function deleteCarParkCarLimitTime(params: any) {
  return axios.delete(
      '/internetOfThingsAdmin/cfCarPark/deleteCarParkCarLimitTime',
      params
  );
}
