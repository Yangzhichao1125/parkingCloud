<template>
  <div class="container">
            ...
            <a-tabs>
              ...
              <a-tab-pane key="3">
                ...
                <a-row :gutter="16">
                  ...
                  <a-col :span="8">
                    <a-form-item field="notPay" label="未支付">
                      <a-switch v-model="formModel.notPay" />
                    </a-form-item>
                  </a-col>
                </a-row>
              </a-tab-pane>
      ...
      <a-row style="margin-bottom: 16px">
        <a-col :span="12">
          <a-space>
            ...
            <a-button type="dashed" status="warning" @click="imitateCarParkUseLogInOrOut">模拟车辆进出</a-button>
          </a-space>
        </a-col>
        <a-col
          :span="12"
    ...
    <imitateCarParkUseLog ref="imitateCarParkUseLogRef" @fetch-data="resetSelectedKeys" />
    <oneClickShowFeeIllustrate ref="oneClickShowFeeIllustrateRef" />
  </div>
</template>
...
<script lang="ts" setup>
  ...
  import imitateCarParkUseLog from './imitateCarParkUseLog.vue';
  import oneClickShowFeeIllustrate from './oneClickShowFeeIllustrate.vue';
  ...
  const imitateCarParkUseLogRef = ref();
  const oneClickShowFeeIllustrateRef = ref();
  const columns = [
    {
      width: 60,
      title: 'id',
  ...
  const imitateCarParkUseLogInOrOut = () => {
    imitateCarParkUseLogRef.value.handleClick(selectedKeys.value);
  }

  const showFeeIllustrate = (useLog: any) => {
    console.log('停车记录', useLog);
    oneClickShowFeeIllustrateRef.value.handleClick(useLog);
  }
  ...
  const cancelOut = async (useLog: any) => {
    let form = {id: useLog.id};
    const { code } = await cancelUseLogOut(form);
    if (code === 10002) {
