      ...
      <a-form ref="formRef" layout="vertical" :model="formData">
        <a-space direction="vertical" :size="16">
          ...
          <a-card class="general-card">
            ...
            <a-row :gutter="80">
              <a-col :span="4">
                <a-form-item label="自动开闸(入场)" field="autoOpenDoor">
              ...
              <a-col :span="4">
                <a-form-item label="赠送免停时间" field="giveFreeTime">
              ...
              <a-col :span="4">
                <a-form-item label="离场限制(分钟)" field="leaveTimeLimit">
              ...
              <a-col :span="4">
                <a-form-item
                    label="起步时长(分钟)"
                    field="startingPriceTime"
                    validate-trigger="input"
                    tooltip="不设置，则使用单位时间，例如设置了120，表示2小时内只收起步价"
                >
                  <a-input
                      v-model="formData.startingPriceTime"
                      placeholder="请输入"
                      allow-clear
                  ></a-input>
                </a-form-item>
              ...
              <a-col :span="4">
                <a-form-item label="过期变临停(天)" field="expireToTemporaryLimit" tooltip="如果月卡车过期了，过期N天后变为临停车">
                  <a-input v-model="formData.expireToTemporaryLimit" placeholder="请输入" allow-clear />
                </a-form-item>
              </a-col>
              <a-col :span="4">
                <a-form-item label="时间控制" field="timeControl">
                  <a-select placeholder="请选择" allow-clear v-model="formData.timeControl">
                    <a-option :value="0">否</a-option>
                    <a-option :value="1">是</a-option>
                  </a-select>
                </a-form-item>
...
const handleEdit = (row: any = null) => {
  ...
  formData.value.startingPriceTime = row.startingPriceTime/60000;
  getCarType();
  visible.value = true;
};
...
const onSubmitClick = () => {
  ...
  formRef.value.validate(async (valid: any) => {
    ...
    newFormData.startingPriceTime = formData.value.startingPriceTime * 60000;
    // @ts-ignore
