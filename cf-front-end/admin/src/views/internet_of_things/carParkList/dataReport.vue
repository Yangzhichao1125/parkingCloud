      ...
      <a-row>
        ...
        <a-col v-if="showPrint" :flex="'86px'" style="text-align: right">
          <a-space direction="vertical" :size="18">
            <a-button type="primary" @click="flushStatisticsPark" v-if="showPrint">
              <template #icon>
                <icon-sync />
              </template>
              刷新报表
...
import { getDailyIncomeStatisticsListByQuery, flushStatisticsParkDatas } from '@/api/visualization';
