              ...
              <a-tabs>
                ...
                <a-tab-pane key="2">
                  ...
                  <a-row :gutter="80">
                    ...
                    <a-col :span="8">
                      ...
                      >
                        ...
                        >
                          ...
                          <a-option :value="4">无需审核</a-option>
                        </a-select>
                      </a-form-item>
                    </a-col>
                    <a-col :span="8">
                    ...
                    <a-col :span="8">
                      <a-form-item field="wxMpAppid" label="微信小程序">
                        <a-select
                            :loading="loading"
                            placeholder="请输入"
                            allow-search
                            allow-clear
                            @search="wxApplicationSearch"
                            :filter-option="false"
                            v-model="formData.wxMpAppid"
                        >
                          <a-option v-for="item of wxApplicationList" :value="item.appid">{{
                              item.applicationName
                            }}</a-option>
                        </a-select>
                      </a-form-item>
                ...
                <a-tab-pane key="3">
                  ...
                  <a-row :gutter="80">
                    ...
                    <a-col :span="8">
                      <a-form-item
                          label="自动清理N天前未付订单(天)"
                          field="cleanNotPayLimit"
                      >
                        <a-input
                            v-model="formData.cleanNotPayLimit"
                            placeholder="请输入"
                            allow-clear
                        ></a-input>
                      </a-form-item>
                ...
                <a-tab-pane key="4">
                  ...
                  <a-row :gutter="80">
                    <a-col :span="8">
                      <a-form-item
                          label="环保管控"
                          field="environmentalControl"
                      >
                        <a-select
                            v-model="formData.environmentalControl"
                            placeholder="请选择"
                            allow-clear
                        >
                          <a-option :value="0">关闭</a-option>
...
<script lang="ts" setup>
  ...
  const wxApplicationSearch = async (_applicationName: any) => {
    const { data, code } = await cfDeveloperGet({
      params: {
        page: 1,
        size: 200,
    ...
    if (code == 10002) {
      wxApplicationList.value = data;
    } else {
      wxApplicationList.value = [];
    }
  };
  const onMapOk = () => {
  ...
  const handleClick = (e: any = null) => {
    if (e?.id) {
      ...
      newInfo.cleanNotPayLimit = e.cleanNotPayLimit / 86400000;
  ...
  const onSubmitClick = () => {
    ...
    formRef.value.validate(async (valid: any) => {
      ...
      newForm.cleanNotPayLimit = String(newForm.cleanNotPayLimit * 86400000);
