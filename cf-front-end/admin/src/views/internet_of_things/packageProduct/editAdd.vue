...
<script lang="ts" setup>
  ...
  const handleClick = (e: any = null) => {
    ...
    if (e?.id) {
      ...
      newInfo.gracePeriod = newInfo.gracePeriod / 86400000
      newInfo.giftTime = newInfo.giftTime / 86400000
  ...
  const onSubmitClick = () => {
    ...
    formRef.value.validate(async (valid: any) => {
      ...
      // @ts-ignore
      if(formData.value.gracePeriod!==''){
        formData.value.gracePeriod = formData.value.gracePeriod * 86400000
      }
      if(formData.value.giftTime!==''){
        formData.value.giftTime = formData.value.giftTime * 86400000
      }
